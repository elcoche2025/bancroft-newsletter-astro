...
## Rollback
The legacy SPA snapshot still exists in `sites/bancroft1.org/nl-f2049c43/` and as a Vercel deployment at `bancroft-newsletter-24nrjsxzz-mws-projects-080b130f.vercel.app`. Emergency rollback:
